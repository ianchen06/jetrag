...
from crawlers.backcountry import Backcountry
...
class TestBackcountry(unittest.TestCase):
    ...
    def test_parser(self):
        html = open('./tests/html/backcountry/product.html').read()
        p = BackcountryParser()
        res = p.parse(html)
    ...
    def test_loader(self):
        ...
        loader = BackcountryLoader(sql_cfg, '', '20221006', True)
