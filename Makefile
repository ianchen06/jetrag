...
model-gen:
	sqlacodegen --noviews --noconstraints --noindexes --outfile ./jetrag/models/zappos.py 'mysql+auroradataapi://:@/zappos?aurora_cluster_arn=arn:aws:rds:us-east:068993006585:cluster:jetrag3&secret_arn=arn:aws:secretsmanager:ap-northeast-1:068993006585:secret:rds-db-credentials/cluster-YXGYNX2ORLFS6RYDNGEBFTMHHA/jetrag-PvBX2f'
